...
def makeModel(nbChannels, shape1, shape2, nbClasses, nbRCL=5,
              nbFilters=512, filtersize=3):

    model = BuildRCNN(nbChannels, shape1, shape2, nbClasses, nbRCL,
                      nbFilters, filtersize)
...
def BuildRCNN(nbChannels, shape1, shape2, nbClasses, nbRCL, nbFilters,
    ...
    def RCL_block(l_settings, l, pool=True, increase_dim=False):
        ...
        conv2 = Convolution2D(out_num_filters, filtersize, filtersize,
